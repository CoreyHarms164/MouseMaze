...
{
    public partial class Hardcore3 : Form
    {
        public Hardcore3()
        {
            InitializeComponent();
        ...
        private void LeftTrigger(object sender, EventArgs e)
        {
            if (start)
            {
                lblLeftV.Visible = false;
                lblLeftH.Visible = true;
            }
        }

        private void RightTrigger(object sender, EventArgs e)
        {
            if (start)
            {
                lblRightH.Visible = false;
                lblRightV.Visible = true;
            }
        }
    }
}
